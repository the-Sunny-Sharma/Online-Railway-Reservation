...
def pnr_status(request):
    if request.method == "POST":
        ...
        first_profile = BookTicket.objects.get(pnrNumber=='pnrNumber')
        messages.success(request, 'Thank you your response is been sent.')
        return render(request,'view_pnr.html',{'key1':first_profile})
...
def bookTicket(request):
    if request.method == "POST":
        ...
        pass2age=request.POST.get('pass2get')
        pass2berth_opt=request.POST.get('pass2berth_opt')
        pass3name=request.POST.get('pass3name')
        pass3age=request.POST.get('pass3get')
        pass3berth_opt=request.POST.get('pass3berth_opt')
        bookTicket = BookTicket(pnr_number=pnr_number,pass1name=pass1name,pass1age=pass1age,pass1berth_opt=pass1berth_opt,pass2name=pass2name,pass2age=pass2age,pass2berth_opt=pass2berth_opt,pass3name=pass3name,pass3age=pass3age,pass3berth_opt=pass3berth_opt)
        # bookTicket = BookTicket(pass1name=pass1name,pass1age=pass1age,pass1berth_opt=pass1berth_opt)
        bookTicket.save()
